...
- Save the report to .jstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.jstack', 'security-reports');
...
- Skip the preamble (jstack-update-check, telemetry, etc.) — go straight to the audit.
