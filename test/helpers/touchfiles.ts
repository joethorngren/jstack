...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'office-hours-forcing-energy':  ['brainstorm/**', 'scripts/resolvers/preamble.ts', 'test/fixtures/mode-posture/**', 'test/helpers/llm-judge.ts'],
  'office-hours-builder-wildness': ['brainstorm/**', 'scripts/resolvers/preamble.ts', 'test/fixtures/mode-posture/**', 'test/helpers/llm-judge.ts'],
  ...
  'context-save-writes-file':       ['context-save/**', 'bin/jstack-slug'],
  'context-restore-loads-latest':   ['context-restore/**', 'bin/jstack-slug'],
  ...
  'context-save-then-restore-roundtrip':   ['context-save/**', 'context-restore/**', 'bin/jstack-slug'],
